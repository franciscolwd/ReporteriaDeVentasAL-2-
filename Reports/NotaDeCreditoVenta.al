report 50121 DTReportNoteCredit
{
    ...
    dataset
    {
        dataitem(Header; "Sales Cr.Memo Header")
        {
            ...
            column(ImporteDescuentoDeFactura; ImporteDescuentoFactura) { }
            ...
            begin
                ...
                SalesInvoiceHeader.SetRange("VAT Registration No.", Header."VAT Registration No.");
                If SalesInvoiceHeader.FindFirst() then Begin
                    NumeroOrden := SalesInvoiceHeader."Order No.";
                    ImporteDescuentoFactura := SalesInvoiceHeader."Invoice Discount Value";
                End
    ...
    var
        ImporteDescuentoFactura: Decimal;
        NumeroOrden: Code[20];
        ...
        FacturaDeVenta_Lbl: label 'Nota de crédito :';
